                        ...
                        <section class="history" data-placeholder="<?= esc_url( get_stylesheet_directory_uri() . '/assets/img/common/no_image.jpg' ); ?>">
                            ...
                            <div class="history__navigation">
                                ...
                                <ul class="history__navigation-list">
                                    <li class="history__navigation-item history__navigation-item--current">1958〜70年代 創業期</li>
                                    <li class="history__navigation-item">1980〜1990年代 プラスチック事業へ</li>
                                    <li class="history__navigation-item">2000年代〜 グローバル企業へ</li>
                                </ul>
                            </div>
