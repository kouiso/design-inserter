<?php
/**
 * インタビュー用サイドバーメニューのセットアップスクリプト
 *
 * 使用方法:
 * WP-CLI: wp eval-file wp-content/themes/muashi/inc/setup-interview-menu.php
 ...
 * インタビュー用サイドバーメニューを作成
 */
function muashi_setup_interview_sidebar_menu() {
...
// スクリプト実行
muashi_setup_interview_sidebar_menu();
