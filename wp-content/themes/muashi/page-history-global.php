<?php
/**
 * Template Name: History Global Page
 */
            ...
            <ul class="navigation__list">
                ...
                <li class="navigation__item">
                    ...
                    <ul class="navigation__item-children">
                        ...
                        <li class="is-current"><a href="<?php echo URL_HISTORY_GLOBAL; ?>">グローバル展開期 2000年〜</a></li>
                    </ul>
                </li>
                <li class="navigation__item">
                        ...
                        <section class="history" data-placeholder="<?= esc_url( get_stylesheet_directory_uri() . '/assets/img/common/no_image.jpg' ); ?>">
                            ...
                            <div class="history__navigation">
                                ...
                                <ul class="history__navigation-list">
                                    ...
                                    <li class="history__navigation-item history__navigation-item--current">グローバル展開期 2000年〜</li>
                                </ul>
                            </div>
